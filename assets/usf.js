/* USF file - DO NOT MODIFY THIS FILE. THIS FILE IS REGULARLY CHANGED BY USF APP AND **ANY DIRECT CHANGES WILL BE LOST**. Use our in-app customization if you need to update CSS and JS code. Auto modified at: 10/22/2025 9:06:23 AM*/
    ...
    <div class="usf-sr-product product-item-v1" :product-selector="product.id" :data-usf-pid="product.id">
        <div class="product mb-30 engoj_grid_parent relative">
            <div class="img-product relative usf-sr-product__image-container">
                ...
                <!-- label product -->
                <figure 
                    v-if="hasDiscount && _usfGlobalSettings.show_sale_label" 
                    :style="'background: ' + _usfGlobalSettings.sale_label_color + ';color: ' + _usfGlobalSettings.sale_label_text_color" 
                    class="absolute uppercase label-sale text-center"
                    v-html="_usfGlobalSettings.sale_label_name"
                >
                </figure>
                <figure 
